...
export const GUILDS = ["React Guild", "Design Guild", "Backend Guild", "Security Guild", "Chef Guild", "Music Guild", "AI/ML Guild", "Game Dev Guild", "Hardware Guild", "Writing Guild", "Web3 Guild", "Mobile Guild", "Cloud Guild", "Data Guild"];
