...
export const SKILLS = ["React", "Next.js", "TypeScript", "Python", "Node.js", "Figma", "Vue", "Go", "Rust", "Swift", "Kotlin", "Solidity", "PostgreSQL", "MongoDB", "Docker", "AWS", "GraphQL", "TailwindCSS", "Unity", "Blender", "Ableton", "After Effects", "Illustrator", "Framer", "C++", "Java", "C#"];
export const GUILDS = ["⚡ React Guild", "🎨 Design Guild", "🔧 Backend Guild", "🔒 Security Guild", "👨‍🍳 Chef Guild", "🎵 Music Guild", "🤖 AI/ML Guild", "🎮 Game Dev Guild", "📐 Hardware Guild", "✍️ Writing Guild", "🌐 Web3 Guild", "📱 Mobile Guild", "☁️ Cloud Guild", "📊 Data Guild"];
export const CRAFTS = ["Tech Founder", "Growth Hacker", "Product Lead", "Design Partner", "Operations Lead", "Marketing Strategist", "Solopreneur", "Creative Director", "Music Executive", "Culinary Entrepreneur", "Independent Creator", "Business Strategist", "Frontend Engineer", "Backend Engineer", "Fullstack Engineer", "Mobile Developer", "Data Scientist", "Machine Learning Engineer", "DevOps Engineer", "Security Researcher", "Smart Contract Engineer", "Hardware Engineer", "Cloud Architect"];
export const INDUSTRIES = ["SaaS / Software", "Fintech", "Gaming", "Healthcare", "E-commerce", "Agency / Studio", "Web3 / Crypto", "AI / ML", "EdTech", "Hardware / IoT", "Media & Entertainment", "Deep Tech", "Cybersecurity", "Cloud Computing"];
