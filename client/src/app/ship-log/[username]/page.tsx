...
import { GitCommit, GitPullRequest, GitBranch, Plus, ChevronDown } from "lucide-react";
            ...
            <div className="luxury-container" style={{ paddingTop: 40, paddingBottom: 80 }}>
                ...
                <div className="luxury-card" style={{ padding: 32, marginBottom: 32 }}>
                    <p className="luxury-overline" style={{ marginBottom: 20, display: "flex", alignItems: "center", gap: 8 }}>
                        ...
                        ATHARVANAVLEKAR&apos;S CONTRIBUTION HEATMAP
                    </p>
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: `repeat(${GRID_SIZE}, 1fr)`, gap: 4, marginBottom: 16, overflowX: "auto", paddingBottom: 4 }}>
                        {Array.from({ length: GRID_SIZE * 7 }).map((_, i) => {
                            const intensity = i > 300 ? Math.random() : 0;
                    ...
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                        <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 12, color: "var(--smoke)" }}>104 contributions in the last year</p>
                ...
                <div style={{ position: "relative", paddingLeft: 32 }}>
                    ...
                    <div style={{ marginBottom: 32, position: "relative" }}>
                        <p style={{ fontFamily: "'DM Sans',sans-serif", fontWeight: 600, fontSize: 13, background: "var(--cream)", display: "inline-block", paddingRight: 12, color: "var(--ink)" }}>March <span style={{ fontWeight: 400, color: "var(--smoke)" }}>2026</span></p>
                    ...
                    <div style={{ marginBottom: 40, position: "relative" }}>
                        ...
                        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 12 }}>
                            <h3 style={{ fontFamily: "'DM Sans',sans-serif", fontWeight: 500, fontSize: 15, color: "var(--ink)" }}>Created 61 commits in 3 repositories</h3>
                        </div>
                        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                            {[
                                { name: "AtharvaNavlekar/Real-Estate-Mumbai", count: 47, percent: 80 },
                                { name: "AtharvaNavlekar/TempRepo", count: 13, percent: 20 },
                                { name: "AtharvaNavlekar/CollabRise", count: 1, percent: 5 }
                            ].map(repo => (
                    ...
                    <div style={{ marginBottom: 40, position: "relative" }}>
                        ...
                        <h3 style={{ fontFamily: "'DM Sans',sans-serif", fontWeight: 500, fontSize: 15, color: "var(--ink)", marginBottom: 16 }}>Created 3 repositories</h3>
                        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                            {[
                                { name: "AtharvaNavlekar/TempRepo", lang: "TypeScript", color: "#3178c6", date: "Mar 5" },
