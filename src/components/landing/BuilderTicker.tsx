...
function TickerItem({ event }: { event: TickerEvent }) {
    return (
        <div className="inline-flex items-center gap-3 px-6 py-3 mx-2 rounded-bento-sm bg-white/[0.03] border border-white/[0.06] whitespace-nowrap flex-shrink-0">
            <PulseTag status={event.status} />
            <span className="font-mono text-sm text-lime font-medium">
                @{event.builder}
            </span>
    ...
    return (
        <div className="w-full overflow-hidden py-8 relative">
            ...
            <div className="flex items-center gap-3 mb-6 px-6 md:px-12">
                <div className="h-px flex-1 bg-gradient-to-r from-transparent via-lime/20 to-transparent" />
