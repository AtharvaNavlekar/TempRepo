...
const INDUSTRY_DATA: Record<string, {
    ...
    developer: {
        ...
        artifacts: [
            { id: "dev-1", title: "Distributed Task Queue", type: "BACKEND", score: 1200, date: "2026-02-01", tags: ["Go", "Redis", "gRPC"], metrics: [{ label: "THROUGHPUT", value: "10K/s" }, { label: "UPTIME", value: "99.99%" }], typeIcon: "⚡" },
            { id: "dev-2", title: "Real-time Collaboration Engine", type: "FULLSTACK", score: 980, date: "2026-01-15", tags: ["WebSocket", "CRDT", "React"], metrics: [{ label: "USERS", value: "5K+" }, { label: "LATENCY", value: "<50ms" }], typeIcon: "🔗" }
        ]
    },
    designer: {
        title: "Designer",
        ...
        artifacts: [
            { id: "des-1", title: "Neon Design System v3", type: "DESIGN SYSTEM", score: 1450, date: "2026-02-10", tags: ["Figma", "Tokens", "A11y"], metrics: [{ label: "COMPONENTS", value: 340 }, { label: "VARIANTS", value: "1.2K" }], typeIcon: "◆" },
            { id: "des-2", title: "E-Commerce Redesign", type: "UI/UX", score: 870, date: "2025-12-08", tags: ["Mobile", "Conversion", "A/B"], metrics: [{ label: "CONVERSION", value: "+34%" }, { label: "NPS", value: 82 }], typeIcon: "🎨" }
        ]
    },
    chef: {
        title: "Chef",
        ...
        artifacts: [
            { id: "chef-1", title: "Zero-Waste Tasting Menu", type: "MENU", score: 920, date: "2026-01-20", tags: ["Sustainability", "Fine Dining"], metrics: [{ label: "COVERS", value: "200+" }, { label: "WASTE", value: "-90%" }], typeIcon: "🔥" },
            { id: "chef-2", title: "Fermentation Lab Protocol", type: "R&D", score: 750, date: "2025-11-15", tags: ["Koji", "Lacto", "Science"], metrics: [{ label: "EXPERIMENTS", value: 45 }, { label: "PUBLISHED", value: "Yes" }], typeIcon: "🧪" }
        ]
    },
    founder: {
        title: "Founder",
        ...
        artifacts: [
            { id: "found-1", title: "Series A Pitch Deck", type: "STRATEGY", score: 1800, date: "2026-02-20", tags: ["VC", "SaaS", "B2B"], metrics: [{ label: "RAISED", value: "$1.5M" }, { label: "MEETINGS", value: 42 }], typeIcon: "🚀" },
            { id: "found-2", title: "Product-Market Fit Analysis", type: "RESEARCH", score: 650, date: "2025-09-01", tags: ["Surveys", "Data", "Pivots"], metrics: [{ label: "INTERVIEWS", value: 120 }, { label: "PIVOTS", value: 2 }], typeIcon: "📊" }
        ]
    },
    musician: {
        title: "Musician",
        ...
        artifacts: [
            { id: "mus-1", title: "Ambient EP: Void Protocol", type: "RELEASE", score: 880, date: "2026-01-30", tags: ["Ambient", "Modular", "Spatial"], metrics: [{ label: "STREAMS", value: "45K" }, { label: "SAVES", value: "3.2K" }], typeIcon: "🎵" }
        ]
    },
    writer: {
        title: "Writer",
        ...
        artifacts: [
            { id: "wri-1", title: "The Builder Manifesto", type: "ESSAY", score: 1100, date: "2026-02-05", tags: ["Culture", "Tech", "Philosophy"], metrics: [{ label: "READS", value: "120K" }, { label: "SHARES", value: "4.5K" }], typeIcon: "✍️" }
        ]
    },
    photographer: {
        title: "Photographer",
        ...
        artifacts: [
            { id: "pho-1", title: "Urban Decay Series", type: "EXHIBITION", score: 950, date: "2026-01-10", tags: ["Street", "B&W", "Editorial"], metrics: [{ label: "PRINTS SOLD", value: 28 }, { label: "FEATURED", value: "3 Mags" }], typeIcon: "📷" }
        ]
    },
    carpenter: {
        title: "Carpenter",
        ...
        artifacts: [
            { id: "carp-1", title: "Live-Edge Conference Table", type: "COMMISSION", score: 1300, date: "2025-12-20", tags: ["Walnut", "Epoxy", "Custom"], metrics: [{ label: "HOURS", value: 120 }, { label: "VALUE", value: "$8K" }], typeIcon: "🪵" }
        ]
    },
    maker: {
        title: "Maker",
        ...
        artifacts: [
            { id: "mak-1", title: "Open-Source Air Quality Monitor", type: "HARDWARE", score: 1050, date: "2026-02-15", tags: ["IoT", "ESP32", "Open Source"], metrics: [{ label: "FORKS", value: 340 }, { label: "DEPLOYED", value: "50+" }], typeIcon: "🔧" }
        ]
    }
};
